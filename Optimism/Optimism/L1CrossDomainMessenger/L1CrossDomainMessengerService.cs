...
namespace Optimism.Contracts.L1CrossDomainMessenger
{
    public partial class L1CrossDomainMessengerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L1CrossDomainMessengerDeployment l1CrossDomainMessengerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L1CrossDomainMessengerDeployment l1CrossDomainMessengerDeployment)
        {
        ...
        public static async Task<L1CrossDomainMessengerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L1CrossDomainMessengerDeployment l1CrossDomainMessengerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public L1CrossDomainMessengerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
