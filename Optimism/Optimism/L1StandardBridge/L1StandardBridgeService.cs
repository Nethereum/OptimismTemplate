...
namespace Optimism.Contracts.L1StandardBridge
{
    public partial class L1StandardBridgeService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L1StandardBridgeDeployment l1StandardBridgeDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L1StandardBridgeDeployment l1StandardBridgeDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<L1StandardBridgeDeployment>().SendRequestAsync(l1StandardBridgeDeployment);
        }

        public static async Task<L1StandardBridgeService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L1StandardBridgeDeployment l1StandardBridgeDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public L1StandardBridgeService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
