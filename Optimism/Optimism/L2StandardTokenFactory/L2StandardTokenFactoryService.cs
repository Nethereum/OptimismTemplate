...
namespace Optimism.Contracts.L2StandardTokenFactory
{
    public partial class L2StandardTokenFactoryService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L2StandardTokenFactoryDeployment l2StandardTokenFactoryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L2StandardTokenFactoryDeployment l2StandardTokenFactoryDeployment)
        {
        ...
        public static async Task<L2StandardTokenFactoryService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L2StandardTokenFactoryDeployment l2StandardTokenFactoryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public L2StandardTokenFactoryService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
