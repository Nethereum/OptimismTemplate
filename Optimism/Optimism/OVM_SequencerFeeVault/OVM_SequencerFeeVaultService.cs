...
using Optimism.Contracts.OVM_SequencerFeeVault.ContractDefinition;

namespace Optimism.Contracts.OVM_SequencerFeeVault
{
    public partial class OVM_SequencerFeeVaultService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, OVM_SequencerFeeVaultDeployment oVM_SequencerFeeVaultDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, OVM_SequencerFeeVaultDeployment oVM_SequencerFeeVaultDeployment)
        {
        ...
        public static async Task<OVM_SequencerFeeVaultService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, OVM_SequencerFeeVaultDeployment oVM_SequencerFeeVaultDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public OVM_SequencerFeeVaultService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
