...
namespace Optimism.Contracts.L2StandardERC20
{
    public partial class L2StandardERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L2StandardERC20Deployment l2StandardERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L2StandardERC20Deployment l2StandardERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<L2StandardERC20Deployment>().SendRequestAsync(l2StandardERC20Deployment);
        }

        public static async Task<L2StandardERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L2StandardERC20Deployment l2StandardERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public L2StandardERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
