...
namespace Optimism.Contracts.L2StandardBridge
{
    public partial class L2StandardBridgeService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L2StandardBridgeDeployment l2StandardBridgeDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L2StandardBridgeDeployment l2StandardBridgeDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<L2StandardBridgeDeployment>().SendRequestAsync(l2StandardBridgeDeployment);
        }

        public static async Task<L2StandardBridgeService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L2StandardBridgeDeployment l2StandardBridgeDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, l2StandardBridgeDeployment, cancellationTokenSource);
        ...
        public L2StandardBridgeService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
