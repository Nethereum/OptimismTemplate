...
{
    public partial class L2DepositedERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L2DepositedERC20Deployment l2DepositedERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<L2DepositedERC20Deployment>().SendRequestAndWaitForReceiptAsync(l2DepositedERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L2DepositedERC20Deployment l2DepositedERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<L2DepositedERC20Deployment>().SendRequestAsync(l2DepositedERC20Deployment);
        }

        public static async Task<L2DepositedERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L2DepositedERC20Deployment l2DepositedERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public L2DepositedERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
