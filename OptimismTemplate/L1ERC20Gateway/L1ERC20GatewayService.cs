...
namespace OptimismTemplate.Contracts.L1ERC20Gateway
{
    public partial class L1ERC20GatewayService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, L1ERC20GatewayDeployment l1ERC20GatewayDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<L1ERC20GatewayDeployment>().SendRequestAndWaitForReceiptAsync(l1ERC20GatewayDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, L1ERC20GatewayDeployment l1ERC20GatewayDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<L1ERC20GatewayDeployment>().SendRequestAsync(l1ERC20GatewayDeployment);
        }

        public static async Task<L1ERC20GatewayService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, L1ERC20GatewayDeployment l1ERC20GatewayDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, l1ERC20GatewayDeployment, cancellationTokenSource);
            return new L1ERC20GatewayService(web3, receipt.ContractAddress);
        }
        ...
        public L1ERC20GatewayService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
